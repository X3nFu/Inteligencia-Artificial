...
Abre **`index.html`** con doble clic (Chrome, Edge, Firefox o Safari) y pulsa
**«Todo al azar y ejecutar»**. No hay que instalar ni compilar nada.
...
Los controles **Ejecutar / Pausar**, **Paso a paso**, **Nuevo mundo** (otro escenario al azar) y
**Reiniciar** (repite el mismo escenario desde el principio) gobiernan la simulación. También
funcionan la **barra espaciadora** (ejecutar/pausar) y la **flecha derecha** (un paso).
